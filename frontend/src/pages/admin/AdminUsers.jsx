...
export default function AdminUsers() {
  ...
  const [form, setForm] = useState({ full_name: '', email: '', phone: '', password: '', role: 'technician', location_type: 'hq' });
  ...
  async function createUser(e) {
    ...
    try {
      ...
      setShowForm(false);
      setForm({ full_name: '', email: '', phone: '', password: '', role: 'technician', location_type: 'hq' });
            ...
            <tbody>
              {users.map((u) => (
                <tr key={u.id} className="border-t">
                  ...
                  <td className="px-4 py-2">{formatLocation(u.location_type)}</td>
