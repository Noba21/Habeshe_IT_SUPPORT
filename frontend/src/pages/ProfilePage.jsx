...
const schema = z.object({
  ...
  location_type: z.enum(['hq', 'factory']).optional(),
...
export default function ProfilePage() {
  ...
  const {
    ...
    defaultValues: { full_name: '', phone: '', email: '', location_type: undefined },
  });
  ...
  useEffect(() => {
    if (user) {
      ...
      if (user.location_type) {
        setValue('location_type', user.location_type);
      }
    }
  }, [user, setValue]);
