...
import { uploadScreenshot, uploadOutsourcingScreenshot, setUploadType } from '../middleware/uploadMiddleware.js';
...
router.put('/:id/outsourcing-screenshot', setUploadType('screenshot'), uploadOutsourcingScreenshot, issueController.uploadOutsourcingScreenshot);
